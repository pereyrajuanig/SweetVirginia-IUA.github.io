...
export default function Perfil() {
  ...
  const [emprendedora, setEmprendedora] = useState(null);
  ...
  function handlePerfilActualizado(
    usuarioActualizado,
    emprendedoraActualizada,
  ) {
    setEmprendedora(emprendedoraActualizada);
    // Nota: el nombre en el AuthContext no se actualiza en caliente en esta versión simplificada,
    // se vería reflejado recién en el próximo login.
  }
      ...
      <div className="bg-white rounded-xl border border-[#E8DDD6] p-6 mb-4">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1">
            <p className="text-xs text-[#A08070] uppercase tracking-wide">
              Teléfono
            </p>
          ...
          {emprendedora && (
            <>
              <div className="flex flex-col gap-1">
                ...
                <p className="text-[#3D2B1F]">{emprendedora.nombre_negocio}</p>
              </div>
              <div className="flex flex-col gap-1">
                <p className="text-xs text-[#A08070] uppercase tracking-wide">
                  Descripción
                ...
                <p className="text-[#3D2B1F]">
                  {emprendedora.descripcion || "Sin descripción."}
                </p>
              </div>
            </>
          )}
