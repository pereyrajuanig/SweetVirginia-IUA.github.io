...
export default function Metricas() {
    ...
    const metricas = [
        { label: "Total pedidos", valor: totalPedidos, color: "bg-[#1E1A17] text-[#C49A6C]" },
        { label: "Pendientes", valor: pedidosPendientes, color: "bg-[#88A5C1] text-white" },
        { label: "Entregados", valor: pedidosEntregados, color: "bg-[#4CAF50] text-white" },
        { label: "Productos activos", valor: productosDisponibles, color: "bg-[#C49A6C] text-[#1E1A17]" },
        { label: "Total productos", valor: totalProductos, color: "bg-[#EEE4DC] text-[#784212]" },
        { label: "Ventas totales", valor: `$${totalVentas.toLocaleString()}`, color: "bg-[#784212] text-[#FDF8F4]" },
    ]
    ...
    return (
        <div className="w-full max-w-4xl mx-auto">
            ...
            {/* Header */}
            <div className="mb-6">
                <h1 className="text-2xl font-semibold text-[#3D2B1F]">Métricas generales</h1>
